...
const Footer: React.FC<FooterProps> = ({ setView }) => {
  ...
  return (
    <footer className="bg-[#2C3531] text-white pt-20 pb-10 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-2xl font-expressive mb-6">04travel</h3>
            <p className="text-white/50 text-sm leading-relaxed mb-6">
              Ваш персональный гид в мир Алтая. Сочетаем древние традиции гостеприимства и технологии будущего.
            </p>
            <div className="mb-8">
              <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#A68B67] mb-5">Подписывайтесь на наши каналы</h4>
              <SocialLinks light />
            </div>
          </div>

          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest text-[#A68B67] mb-6">Навигация</h4>
          ...
          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest text-[#A68B67] mb-6">Юридическая информация</h4>
            <ul className="space-y-4 text-white/70 text-sm">
              ...
              <li><button onClick={() => handleNav('postDetail', '%d0%bf%d0%be%d0%bb%d0%b8%d1%82%d0%b8%d0%ba%d0%ba%d0%b0-%d0%ba%d1%83%d0%ba%d0%b8')} className="hover:text-white transition-colors text-left">Cookies</button></li>
            </ul>
          </div>

          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest text-[#A68B67] mb-6">Рейтинги</h4>
            <div className="space-y-4">
              <a
                href="https://yandex.ru/maps/org/aktash_vibes/136013722623/"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white/5 rounded-2xl border border-white/10 overflow-hidden flex items-center justify-center p-2 min-h-[74px] hover:bg-white/10 transition-colors cursor-pointer"
              >
                <iframe
