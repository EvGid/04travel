...
export const TOURS_DATA: ITourDefinition[] = [
  ...
  { wp_id: '45', title: 'Джип-туры по Алтаю', slug: 'джип-туры-по-алтаю', image: '/images/chuyskiy-trakt-doroga-altay3.webp' },
  { wp_id: '42', title: 'Белуха: туры и маршруты', slug: 'белуха', image: '/images/chuyskiy-trakt-doroga-altay2.webp' },
  ...
  { wp_id: '38', title: 'Долина Чулышмана: маршрут, туры и водопады', slug: 'долина-чулышмана', image: '/images/chulyshman/pereval-katu-yaryk-dolina-chulyshman-altay12.webp' },
  ...
  { wp_id: '40', title: 'Алтай Марс (Кызыл-Чин): экскурсии и туры', slug: 'алтай-марс-кызыл-чин-экскурсии-и-туры', image: '/images/mars/mars-kyzyl-chin-altay1-rotated.webp' },
  { wp_id: '36', title: 'Гейзеровое озеро на Алтае: как попасть и туры', slug: 'гейзеровое-озеро-на-алтае-как-попасть' },
  { wp_id: '35', title: 'Телецкое озеро: туры и экскурсии', slug: 'телецкое-озеро-туры-и-экскурсии', image: '/images/teleckoe-ozero-artybash-altay12.webp' },
  ...
  { wp_id: '500', title: 'Трансфер по Республике Алтай из аэропорта', slug: 'transfer-gorny-altay', image: '/images/chuyskiy-trakt-doroga-altay1.webp' },
